...
$allProducts = $products->fetchAll(PDO::FETCH_OBJ); // fetchAll to get all rows as objects
		...
		<div class="wrap d-md-flex align-items-xl-end">
			...
			<div class="book p-4">
				...
				<form action="bookings/book.php" method="POST" class="appointment-form">
					...
					<div class="d-md-flex">
						<div class="form-group">
							<textarea id="" cols="30" rows="2" name="message" class="form-control" placeholder="Message"></textarea>
						</div>
						<div class="form-group ml-md-4">
	...
	<div class="container">
		...
		<div class="row">
			<?php foreach ($allProducts as $products): ?>
				<div class="col-md-3">
					<div class="menu-entry">
						<a href="products/product-single.php?product_id=<?= $products->id ?>" class="img" style="background-image: url(images/<?= $products->image ?>);"></a>
						<div class="text text-center pt-4">
							<h3><a href="#"><?= $products->name ?></a></h3>
							<p><?= $products->description ?></p>
							<p class="price"><span>$<?= $products->price ?></span></p>
							<p><a target="_blank" href="products/product-single.php?product_id=<?= $products->id ?>" class="btn btn-primary btn-outline-primary">Add to Cart</a></p>
						</div>
					</div>
				</div>
			<?php endforeach ?>
